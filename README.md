...
- 기본 문법
    ...
    2. 예외처리
        ...
        https://github.com/user-attachments/assets/d38cafc7-0778-444a-87b7-58932672d4f9
...
- C# 기본
    ...
    - 모달창, 모달리스창 : 창위에 다른 창을 띄울때 접근 권한 제어 형태
...
- WPF 검포넌트(실무에서 쓰이는 UI 컴포넌트, 윈앱도 존재) - Third Party
