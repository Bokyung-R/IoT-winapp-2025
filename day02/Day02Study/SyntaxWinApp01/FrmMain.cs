namespace SyntaxWinApp01
{
    public partial class FrmMain : Form
    {
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            ...
            int intVal = 2147483647;        // int : -21억 ~ 21억 (4bytes)
            ...
            long lngVal = 0;  // 900000...  // long : -92경 ~ 92경
            ulong ulngVal = 0;              // unsigned long : 1800경 (8bytes) 
            ...
            string str01 = "Hello\0 World";     // '\0' : end of line
            ...
            // Nullable
            //int int02 = null;       // 기본타입(정수형, 실수형, 불린 / 문자열 제외)은 null을 힐딩힐 수 없음
            int? int03 = null;      //   ? 붙여줄 것
