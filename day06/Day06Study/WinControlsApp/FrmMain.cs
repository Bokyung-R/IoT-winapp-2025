namespace WinControlsApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            toolTip1.SetToolTip(TxtYear, "캘린더 선택년도 표시 텍스트박스입니다.");
        ...
        private void ChangeFont()
        {
            ...
            {
                style |= FontStyle.Italic;  // 0001 | 0010 => 0011 (Bold | Italic)
            }

            // CboFonts에서 선택된 글자로, 글자 크기는 12, 글자체 스타일적용
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            // 모달리스 창을 모달창처럼  메인창 정중앙에 위치하려면 계산 필요
        ...
        private void BtnOpenImage_Click(object sender, EventArgs e)
        {
            ...
            DlgOpenImage.Filter = "Image File(*.bmp;*jpg;*.png)|*.bmp,*.jpg;*.png";

            if (DlgOpenImage.ShowDialog() == DialogResult.OK)
            {
                PicImage.Image = Bitmap.FromFile(DlgOpenImage.FileName);
                PicImage.SizeMode = PictureBoxSizeMode.Zoom;    // PictureBoxSize.Zoom 이미지 원본대로 볼 수 있는 모드
                // PictureBoxSizeMode.StrectchImage 이미가 넓이, 높이를 픽처박스 크기에 맞춰서 이미지가 일그러짐
            }
        }
        ...
        private void MnuExit_Click(object sender, EventArgs e)
        {
            ...
            {
                this.FormClosing -= FrmMain_FormClosing;        // 폼클로징 이벤트를 삭제 (2번 실행되던 부분)
